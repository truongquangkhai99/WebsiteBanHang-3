...
<%
	Map<String, Category> mapListTheLoai = CategoryDAO.mapLoaiSanPham;
%>
<!DOCTYPE html>
<html>
<head>
        ...
        <div>
            <table id="datatable-buttons" class="table table-striped table-bordered">
                ...
                <tbody>
                    <%
						int count = 0;
						for (Category kh : mapListTheLoai.values()) {
							count++;
					%>
                        <tr>
                            <td>
...
<div id="addModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addForm" action="category?chucNang=Add" method="post" enctype="multipart/form-data">
...
<div id="editModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="editForm" action="category?chucNang=Edit" method="post" enctype="multipart/form-data">
