...
Book sp = BookDAO.mapSanPham.get(id);
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container">
		<div class="row">
			<h2>
				<strong>Sửa sản phẩm</strong> <a href="../showproduct.jsp"
		...
		<div class="form-center">
			<form class="form-horizontal"
				action="../Product?chucNang=Edit&masp=<%=sp.getId()%> "
				method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<input type="text" class="form-control"
									value="<%=sp.getPrice()%>" name="price"
									placeholder="Nhập giá sản phẩm" id="cost">
							</div>
							<div class="col-sm-2">
								<p id="icon-cost"></p>
							</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<select type="text" class="form-control" list="listProducer"
									value="<%=sp.getPublisher_id()%>" name="NSXID"
									placeholder="Nhập mã nhà sản xuất" id="producerID">
									<datalist id="listProducer">
										...
										for (Publisher kh : mapListPublisher.values()) {
											if (kh.getId().equals(sp.getPublisher_id()))
												out.print("<option selected value=" + kh.getId() + ">" + kh.getName() + "</option>");
											else {
