...
Product sp = ProductDAO.mapProduct.get(id);
%>
<!DOCTYPE html>
<html>
<head>
			...
			<form  class="form-horizontal" action="../Product?chucNang=Edit&masp=<%=sp.getProductID()%> " method="post">
				...
				<label class="control-label col-sm-2" for=""><span class=""></span> Tên sản phẩm:</label>
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<input type="text" class="form-control"  value="<%=sp.getProductName() %>" name="pdName" placeholder="Tên sản phẩm" id ="name">
							</div>
							<div class="col-sm-2">
								<p id="icon-name"></p>
							</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<input type="text" class="form-control"  value="<%=sp.getPrice()%>" name="price" placeholder="Nhập giá sản phẩm" id="cost">
							</div>
							<div class="col-sm-2">
								<p id="icon-cost"></p>
							</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-8">
								<input type="text" class="form-control"   list="listProducer" value="<%=sp.getProducerID()%>" name="NSXID" placeholder="Nhập mã nhà sản xuất" id="producerID">
