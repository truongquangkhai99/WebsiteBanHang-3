...
(function(h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": Kích hoạt tính năng sắp xếp tăng dần",
                sSortDescending: ": Kích hoạt tính năng sắp xếp giảm dần"
            },
            oPaginate: {
                sFirst: "Đến",
                sLast: "Về",
            ...
            sEmptyTable: "Không có dữ liệu thích hợp trong bảng",
            sInfo: "Hiển thị _START_ từ _END_ của _TOTAL_ phần tử",
            sInfoEmpty: "Hiển thị 0 từ 0 của 0 phần tử",
            sInfoFiltered: "(Đã lọc từ _MAX_ trên tổng số phần tử)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
