...
<link rel="stylesheet"
	...
	crossorigin="anonymous" />
<link
	href="Assets/Admin/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css"
	rel="stylesheet" media="all">
<link href="Assets/Admin/vendor/wow/animate.css" rel="stylesheet"
	media="all">
<link href="Assets/Admin/vendor/css-hamburgers/hamburgers.min.css"
	rel="stylesheet" media="all">
<link href="Assets/Admin/vendor/slick/slick.css" rel="stylesheet"
	media="all">
<link href="Assets/Admin/vendor/select2/select2.min.css"
	rel="stylesheet" media="all">
<link href="Assets/Admin/vendor/perfect-scrollbar/perfect-scrollbar.css"
	rel="stylesheet" media="all">
...
<body>
	<div class="container-fluid">
								...
								<div class="account-item clearfix js-item-menu">
									...
									<div class="account-dropdown js-dropdown">
										<div class="info clearfix">
											<div class="image">
												<a href="#"> <img
													src="Assets/Admin/images/icon/avatar-01.jpg" alt="Avatar" />
												</a>
											</div>
											<div class="content">
												<h5 class="name">
		...
		<div class="row">
				...
				<aside class="menu-sidebar d-none d-lg-block">
					<div class="logo">
						<a href="index.jsp"> <img
							src="Assets/Admin/images/icon/LOGO.png" alt="Admin" />
						</a>
					</div>
						...
						<nav class="navbar-sidebar">
							<ul class="list-unstyled navbar__list">
								...
								<li><a class="js-arrow" href="#"> <i
										class="fas fa-pencil-square"></i>Cập Nhật
								</a>
									<ul class="list-unstyled navbar__sub-list js-sub-list">
										<li><a href="#"><i class="fas fa-book"></i>Đầu Sách</a></li>
										<li><a href="#"><i class="fas fa-users"></i>Tác giả </a>
										</li>
										<li><a href="#"><i class="fas fa-filter"></i>Thể Loại</a>
										</li>
										<li><a href="#"><i class="fas fa-industry"></i>Nhà
												Xuất Bản</a></li>
									</ul></li>
								<li><a href="#"> <i class="fas fa-chart-bar"></i>Thống
										kê doanh thu
								</a></li>

								<li><a href="showorder.jsp"> <i
										class="fas fa-cart-plus"></i>Đơn Hàng
								</a></li>
								<li><a href="showcustomer.jsp"> <i class="fas fa-user"></i>Khách
										Hàng
								</a></li>

								<li><a href="#"> <i class="fas fa-percent"></i>Khuyễn
										mại
								</a></li>
							</ul>
						</nav>
			...
			<div class="col-sm-9" style="padding-top: 90px">
				<jsp:doBody/>
			</div>
		</div>
	</div>
	...
	<script
		src="Assets/Admin/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
	...
	<script
		src="Assets/Admin/vendor/circle-progress/circle-progress.min.js"></script>
	<script
		src="Assets/Admin/vendor/perfect-scrollbar/perfect-scrollbar.js"></script>
